...
/**
 *  Service class that provides CRUD and custom operations against the planElementDbAdapterOutput data object.
 *  The behavior of this class is driven by the planElementDbAdapterOutput classMappingDescriptor in persistence-mapping.xml.
 *
 ...
 */
public class PlanElementDbAdapterOutputService extends EntityCRUDService<PlanElementDbAdapterOutput> {

    /**
     * Default constructor. If autoQuery is set to true in the classMappingDescriptor in persistence-mapping.xml, then
     * the findAll method will be executed and the planElementDbAdapterOutput list will be populated when this constructor is invoked.
     ...
     *
     * PlanElementDbAdapterOutputService crudService = (PlanElementDbAdapterOutputService) EntityUtils.getEntityCRUDService(PlanElementDbAdapterOutput.class);
     *
     ...
     * data control there.
     */
    public PlanElementDbAdapterOutputService() {
    }
     ...
     */
    public PlanElementDbAdapterOutputService(boolean autoQuery) {
        super(autoQuery);
    }
     ...
     */
    public PlanElementDbAdapterOutputService(boolean doRemoteReadInBackground, boolean doRemoteWriteInBackground) {
        super(false);
    ...
    protected Class getEntityClass() {
        return PlanElementDbAdapterOutput.class;
    }

    protected String getEntityListName() {
        return "planElementDbAdapterOutput";
    }

    public List<PlanElementDbAdapterOutput> getPlanElementDbAdapterOutput() {
        return getEntityList();
    }

    /**
     * This method is automatically called when using the Create operation on the planElementDbAdapterOutput collection
     * in the data control palette.
     *
     * Note that this method does NOT add the planElementDbAdapterOutput to the entity list because this method is
     ...
     * logic there. The CDM EntityList class ensures that this method is called after a planElementDbAdapterOutput has been added.
     ...
     * instead to ensure that iterator binding and planElementDbAdapterOutput list stay in sync.
     * @param index
     * @param planElementDbAdapterOutput
     */
    public void addPlanElementDbAdapterOutput(int index, PlanElementDbAdapterOutput planElementDbAdapterOutput) {
        addEntity(index, planElementDbAdapterOutput);
    }

    /**
     * Sets planElementDbAdapterOutput state to new, and if addToList argument is true, it adds the planElementDbAdapterOutput to the
     * planElementDbAdapterOutput list and and fires change event to refresh the list in the UI
     * @param index
     * @param planElementDbAdapterOutput
     * @param addToList
     */
    public void addPlanElementDbAdapterOutput(int index, PlanElementDbAdapterOutput planElementDbAdapterOutput,
                                              boolean addToList) {
        addEntity(index, planElementDbAdapterOutput, addToList);
    }

    /**
     * This method is automatically called when using the Delete operation on the planElementDbAdapterOutput collection
     ...
     *
     * Note that this method does NOT remove the planElementDbAdapterOutput from the entity list because this method is
     ...
     * logic there. The CDM EntityList class ensures that this refresh method is called after a planElementDbAdapterOutput has been added.
     *
     * Do NOT drag and drop this method from the data control palette, use the Delete operation
     * instead to ensure that iterator binding and planElementDbAdapterOutput list stay in sync.
     * @param planElementDbAdapterOutput
     */
    public void removePlanElementDbAdapterOutput(PlanElementDbAdapterOutput planElementDbAdapterOutput) {
        removeEntity(planElementDbAdapterOutput);
    }


    /**
     * Removes a planElementDbAdapterOutput using the configured local and remote persistence managers.
     * If removeFromList argument is true, it removes the planElementDbAdapterOutput from the
     * a planElementDbAdapterOutput list and and fires change event to refresh the list in the UI
     * @param a planElementDbAdapterOutput
     * @param removeFromList
     */
    public void removePlanElementDbAdapterOutput(PlanElementDbAdapterOutput planElementDbAdapterOutput,
                                                 boolean removeFromList) {
        removeEntity(planElementDbAdapterOutput, removeFromList);
    }

    /**
     * Inserts or updates a planElementDbAdapterOutput using the configured persistence managers.
     * The insert or update is determined by calling isNewEntity on the planElementDbAdapterOutput instance.
     * @param planElementDbAdapterOutput
     */
    public void savePlanElementDbAdapterOutput(PlanElementDbAdapterOutput planElementDbAdapterOutput) {
        super.mergeEntity(planElementDbAdapterOutput);
    }

    /**
     * Retrieves all planElementDbAdapterOutput instances using the configured persistence managers and populates the planElementDbAdapterOutput list
     * with the result.
     ...
     */
    public void findAllPlanElementDbAdapterOutput() {
        super.findAll();
    }

    /**
     * Retrieves all planElementDbAdapterOutput instances using the findAll method on the remote persistence manager
     * and populates the planElementDbAdapterOutput list
     */
    public void findAllPlanElementDbAdapterOutputRemote() {
        super.doRemoteFindAll();
    }

    /**
     * Retrieves the planElementDbAdapterOutput instances that match the searchValue filter using the configured persistence
     * managers and populates the planElementDbAdapterOutput list with the result.
     ...
     * @param searchValue
     */
    public void findPlanElementDbAdapterOutput(String searchValue) {
        super.find(searchValue);
    }


    /**
     * Resets the values of the planElementDbAdapterOutput instance to the values as stored in the SQLite database. This method
     * will do nothing when the planElementDbAdapterOutput is not persisted to the database.
     * @param planElementDbAdapterOutput
     */
    public void resetPlanElementDbAdapterOutput(PlanElementDbAdapterOutput planElementDbAdapterOutput) {
        super.resetEntity(planElementDbAdapterOutput);
    }
